...
package uk.co.sarahjohnston.museoglasgow.view;
...
import uk.co.sarahjohnston.museoglasgow.R;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VERTICAL_PADDING_DIPS = 16;
    private static final int TAB_SIDE_PADDING_DIPS = 8;
     ...
     * When using {@link //edu.dartmouth.cs.actiontabs.view.SlidingTabLayout} you are
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        int side_padding = (int) (TAB_SIDE_PADDING_DIPS * getResources().getDisplayMetrics().density);
        int vertical_padding = (int) (TAB_VERTICAL_PADDING_DIPS * getResources().getDisplayMetrics().density);
        textView.setPadding(side_padding, vertical_padding, side_padding, vertical_padding);
